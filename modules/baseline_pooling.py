...
class BaselinePooling(nn.Module):
    ...
    def _avg_pooling(self, text_embeds, video_embeds):
        ...
        video_embeds_pooled = video_embeds.mean(dim=1)
        #video_embeds_pooled, _= self.gpo(video_embeds, gpo_mask)
        #video_embeds_list.append(video_embeds_pooled)
        #video_embeds_p = torch.stack(video_embeds_list, dim=1)
